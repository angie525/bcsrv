...
public class FabricManager {
    ...
    private FabricManager()
        ...
        String rootPath="sadf";
        manager = new ChaincodeManager(getConfig(rootPath));
    }
     ...
     * @return 节点服务器配置
     */
    private FabricConfig getConfig(String rootPath) {
...
//                "grpc://116.196.64.241:7053", "http://116.196.64.241:7054");
    ...
    private Chaincode getChaincode(String channelName, String chaincodeName, String chaincodePath, String chaincodeVersion) {
        ...
        chaincode.setInvokeWaitTime(Integer.parseInt(configMap.get("invokeWatiTime").toString()));
        chaincode.setDeployWaitTime(Integer.parseInt(configMap.get("deployWatiTime").toString()));
        return chaincode;
    }
